...
<strong> sudo apt-get install lamp-server^</strong> This will install all 3 of them.<br></br>
                            ...
                            <img  className="blog_img img-thumbnail" alt="" src={mediawiki2}></img>
...
You now need to create a Gerrit account and add the SSH key. Follow the following steps.<br></br><br></br>
                            <ul className="list-group">
                                <li className="list-group-item" id="special">1. Go to wikitech.wikimedia.org.</li>
                                <li className="list-group-item" id="special">2. Log into the web interface of Gerrit.</li>
                                <li className="list-group-item" id="special">3. Go to settings and click on “SSH Public Keys”</li>
                                <li className="list-group-item" id="special">4. Paste your ssh key into the corresponding filed</li>
                            </ul><br></br>
...
In order not to get “Permission denied”, you should run <strong>ssh -p 29418 USERNAME@gerrit.wikimedia.org</strong>
                            ...
                            <img className="blog_img img-thumbnail" alt="" src={mediawiki1}></img>
...
Now try localhost/core/ again. It should work.
                            ...
                            <p className="blog-content">
                                ...
                                <img className="blog_img img-thumbnail" src={mediawiki3} alt="" ></img><br></br><br></br>
                            ...
                            <p className="blog-content">
                                ...
                                <img className="blog_img img-thumbnail" src={mediawiki} alt="" ></img>
                            </p>
        </div>
    );
}
