...
<img className="blog_img" src={Asia} alt=""></img><br></br><br></br>
...
<img className="blog_img" src={WorkShop} alt=""></img><br></br><br></br>
...
<img className="blog_img" src={Dance} alt=""></img><br></br><br></br>
...
<img className="blog_img" src={Group} alt=""></img><br></br><br></br>
...
<img id="unique" className="blog_img" src={Director} alt=""></img><br></br><br></br>
...
<img className="blog_img" src={FishCurry} alt=""></img><br></br><br></br>
...
<img className="blog_img" src={Boarding} alt=""></img><br></br><br></br>
The next morning, I took a plane back to India, waving goodbye to Indonesia 😉<br></br><br></br>
<img id="unique" className="blog_img" src={Sponsor} alt=""></img>
                                </p>
        </div>
    );
}
