...
function SchoolVisit() {
    return (
                        <div>
                            ...
                            <img id="special" className="blog_img" src={School} alt=""></img><br></br><br></br>
                            It all happened on the 17th of September of 2019. Our batch was assigned Amrita Vidyalayam, which is found in Paripally. We had to explain our topic, which was “Civic Responsibility” to a 10th standard className. We were pretty confident since all of us had prepared our respective section meticulously.<br></br><br></br>
...
<img id="special" className="blog_img" src={GroupFoto} alt=""></img><br></br><br></br>
...
<img  id="special" className="blog_img" src={GroupFoto2} alt=""></img>
...
<img className="blog_img" id="special" src={Foto3} alt=""></img><br></br><br></br>
...
<img className="blog_img" id="unique" src={Foto4} alt=""></img>
<p className="custom-text text-center">Gopika Dancing</p>
                            </p>
        </div>
    );
}
