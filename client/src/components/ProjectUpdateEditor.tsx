...
import { SideSheet, Heading, Paragraph, Pane, Card, TextInputField, Button } from 'evergreen-ui';
...
const ProjectUpdateEditor = ({id, title, desc, link, demolink, isShown, setIsShown}: ProjectPropsType) => {
