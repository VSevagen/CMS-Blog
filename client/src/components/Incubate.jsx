...
import IND from "../public/incubate.jpg"
import Eval from "../public/evaluation.jpg"
...
<strong>3rd</strong>: It is not only limited to disasters. We could any kind of trending information on twitter and decide what action to take. If it is terrorist related tweets for example, “Bin Laden is planning an attack on India” (This is an example, do not take it seriously) , we could intercept that and take necessary actions.<br></br><br></br>
So we created the application, tested it, prepared a slideshow and got ready for the first evaluation which is going to be conducted by the Jury.<br></br><br></br>
...
At midnight, we started looking for a new idea as presenting or improving the same idea would definitely not cut it. We knew that the next evaluation was going to be at 9.00 am so we had approximately 9 hours to find, decide, explore, implement and prepare a presentation . This was nearly not enough time but we did not have a choice so we got to work 🙂<br></br><br></br>

By 9.00 am, it was time for the second and last evaluation. We had everything prepared, the slideshow, the video, the demo etc… We anxiously waited for our turn and finally our names were called. We entered the room very stressful as we knew that it was our last chance to showcase ourselves to get a chance of getting selected for the final pitch.<br></br><br></br>

We learned from our previous “disaster”, that we had to improve some points namely the project but also our presentation skill. So this time, we made a plan of what exactly should we say.<br></br><br></br>

<strong>1st</strong> : We should state our problem statement first, exactly what problem we’re solving so that we can limit the extend of thinking of the Judges. If we do not put this restriction, they are free to talk about anything that can connect to the topic and they are gonna do so.<br></br><br></br>

<strong>2nd</strong> : We should think about the disadvantages rather than the advantages of the idea. This will help guess what kind of question the Jury might ask beforehand which can give us a drastic advantage.<br></br><br></br>

So this is our second idea,<br></br><br></br>
...
The second evaluation went pretty well. We could answer their questions correctly and pitch some good points in. Now it was up to luck !<br></br><br></br>

At noon, the list of those who got selected for the final pitch was announced. So this is how it went, a team was announced, then they had to go pitch there idea to the Jury but in a more detailed manner. Moreover this was done not only in front of the Jury but the other participants too. So an actual panel of 70 to 80 people was listening to the pitch.<br></br><br></br>

So the list of teams went on and finally our team was called !<br></br><br></br>
